...
$(function () {
  ...
  (function () {
    ...
    function searchFactory() {
      var worker = new Worker(relHref + 'docfx/search-worker.js');
      ...
      function localSearch() {
        ...
        // MOD: indexPath was: relHref + "index.json"
      ...
      function webWorkerSearch() {
        ...
        indexReady.promise().done(function () {
          console.log("lunr index parsed, ready for search");
  ...
  (function () {
    ...
    // NOTE: removed loadNavbar() from original
    loadToc();
    ...
    function loadToc() {
      ...
      // MOD: added root to breadcrumns (it was in loadNavbar)
      breadcrumb.insert({
          href: "index.html",
          name: "API Server"
        }, 0);
  ...
  (function () {
    ...
    function getHierarchy() {
      ...
      // MOD: removed .article class from selector
